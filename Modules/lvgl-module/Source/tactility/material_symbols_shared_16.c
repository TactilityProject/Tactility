...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x7d, 0x0, 0x0, 0x28, 0x0, 0x0,
    0x28, 0x0, 0x0, 0x3c, 0x0, 0x0, 0xff, 0x0,
    0x17, 0xc3, 0xd4, 0xff, 0x0, 0xff, 0xfd, 0x0,
    0x7f, 0xfc, 0x0, 0x3f,
    ...
    /* U+F190 "" */
    0x0, 0x0, 0x0, 0x0, 0x0, 0xb, 0x0, 0x40,
    0x2d, 0x3, 0xf0, 0xb4, 0xf, 0x3e, 0xd0, 0x3c,
    0xb, 0x47, 0xb0, 0x0, 0x7, 0x43, 0x0, 0x87,
    0x7, 0x10, 0xd7, 0x7, 0x34, 0xd7, 0xc7, 0x34,
    0xd7, 0xc3, 0x34, 0xc3,

    /* U+F7AB "" */
    0x0, 0x0, 0x0, 0x0, 0x1, 0xbf, 0xfd, 0x0,
    0xf, 0xff, 0xff, 0xe0, 0x7f, 0x40, 0x6, 0xfc,
    0xb8, 0x0, 0x0, 0x3d, 0x0, 0x6f, 0xd0, 0x0,
    0x2, 0xff, 0xd0, 0x0, 0x2, 0xd0, 0x3, 0x80,
    0x0, 0x0, 0x3f, 0xf8, 0x0, 0x7, 0x38, 0x34,
    0x0, 0x7, 0x38, 0x34, 0x0, 0x0, 0x3f, 0xf8,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 42, .adv_w = 256, .box_w = 10, .box_h = 14, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 77, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 119, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 168, .adv_w = 256, .box_w = 8, .box_h = 5, .ofs_x = 4, .ofs_y = 6},
    {.bitmap_index = 178, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 220, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 256, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 292, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 328, .adv_w = 256, .box_w = 10, .box_h = 10, .ofs_x = 3, .ofs_y = 3},
    {.bitmap_index = 353, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 389, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 437, .adv_w = 256, .box_w = 13, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 476, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 518, .adv_w = 256, .box_w = 14, .box_h = 13, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 564, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 600, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 649, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 698, .adv_w = 256, .box_w = 10, .box_h = 14, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 733, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 769, .adv_w = 256, .box_w = 14, .box_h = 12, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 811, .adv_w = 256, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 875, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 911, .adv_w = 256, .box_w = 14, .box_h = 13, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 957, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 999, .adv_w = 256, .box_w = 13, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1038, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 1086, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1122, .adv_w = 256, .box_w = 16, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 1170, .adv_w = 256, .box_w = 12, .box_h = 12, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 1206, .adv_w = 256, .box_w = 16, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x87, 0x16e, 0x1b6, 0x1bd, 0x1cd, 0x1dc, 0x29b,
    0x404, 0x474, 0x47c, 0x4e5, 0x5ec, 0x743, 0x756, 0x75d,
    0x75f, 0x7a4, 0x7b6, 0x7d5, 0x860, 0x89b, 0x89e, 0xa3e,
    0xac3, 0xde7, 0xecf, 0xf37, 0x1003, 0x1037, 0x1652, 0x176e
};
...
{
    {
        .range_start = 57689, .range_length = 5999, .glyph_id_start = 1,
