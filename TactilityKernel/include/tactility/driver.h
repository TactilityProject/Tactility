...
struct Driver {
    ...
    /**
     * Optional: reports whether the hardware is physically present. Checked by driver_bind()
     * and periodically by device_hotplug_poll_once(). NULL means always present.
